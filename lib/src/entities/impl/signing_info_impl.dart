...
class SigningInfoImpl extends SigningInfo {
  SigningInfoImpl(
    Map<String, dynamic> data,
          ...
          signingCertificateHistory: asTypedList(
            data['signingCertificateHistory'],
          ),
          apkContentSigners: asTypedList(
            data['apkContentSigners'] ?? data['apkContentsSigners'],
          ),
          hasPastSigningCertificates:
              data['hasPastSigningCertificates'] ?? false,
